...
export interface Recommendation {
  ...
  status: 'Open' | 'Applied' | 'Dismissed' | 'Pending' | 'In Progress' | 'Completed';
  riskSource?: string;
  recommendedAction?: string;
  owner?: string;
  expectedImpactPercent?: number;
  category?: 'Reassign overloaded employee tasks' | 'Resolve SLA breach incidents' | 'Reduce delivery delay risk' | 'Stabilize department workload';
}

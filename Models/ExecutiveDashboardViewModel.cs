...
namespace IntelliOps.Models
{
    public class ExecutiveDashboardViewModel
    {
        ...
        public int ActiveAlertsCount { get; set; } // Serves as the Consolidated Incidents Count
        public int ActiveIncidentsCount { get; set; } // Consolidated Incidents Count
        public int UnderlyingAlertSignalsCount { get; set; } // Raw Alert Signals Count
        public List<ConsolidatedIncident> ConsolidatedIncidents { get; set; } = new List<ConsolidatedIncident>();
        ...
        public List<Alert> ActiveAlerts { get; set; } = new List<Alert>(); // Keep for backward compatibility / list of raw signals if needed
